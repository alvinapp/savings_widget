...
export const ClassicAccount = ({}: ClassicAccountProps) => {
    return (
        <div className="flex flex-col items-center mx-3.5 mb-5">
            ...
            <div className="font-poppins font-medium text-skin-subtitle text-xs text-center md:text-sm lg:text-base xl:text-lg mb-6">
                Something else that is a bit longer than the other one. Something else that is a bit longer.
            </div>
            <div className="w-full">
                <Accordion title="Interest rate" content="Something else that is a bit longer than the other one" />
                <Accordion title="Opening requirement" content="Something else that is a bit longer than the other one. Something else that is a bit longer than the other one" isOpen={true} />
            </div>
            <MainButton
                // isDisabled={!isValid}
