  ...
  return (
    <div className="">
      <div className="flex flex-col items-center mx-3.5 mb-5">
        ...
        <div className="font-custom text-base font-bold text-skin-base tracking-title mb-2 mt-3 text-center">
          Hooray! savings account created successfully.
        </div>
        <div className="font-custom font-medium text-skin-subtitle text-xs text-center md:text-sm lg:text-base xl:text-lg mb-6">
      ...
      <div className="flex flex-col items-center mx-3.5 pt-12">
        <div className="text-base font-semibold font-custom tracking-longest_text text-skin-primary border border-skin-primary w-full rounded-lg h-14 flex flex-row items-center justify-center">
