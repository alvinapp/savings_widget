...
(self["webpackChunksavings_widget"] =
  ...
  [
    "src_client_pages_components_CustomDatePicker_tsx-src_client_pages_components_goal-creation_Bo-11d085",
  ],
  {
  ...
  \**********************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ CustomDatePicker: () =>
            /* binding */ CustomDatePicker,
          /* harmony export */
        });
        ...
        /* harmony import */ var react_icons_fi__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! react-icons/fi */ "./node_modules/react-icons/fi/index.esm.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/isSameMonth/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/subMonths/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/addMonths/index.js"
          );
        ...
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/addDays/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/startOfMonth/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_11__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/endOfMonth/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_12__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/endOfWeek/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_13__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/isSameDay/index.js"
          );
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_14__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/esm/isAfter/index.js"
          );

        const ModalOverlay = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  position: fixed;
  top: 0;
  ...
  z-index: 999;
`;
        const CalendarContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  ...
  position: relative;
`;
        const Header = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"]
          .div`
  display: flex;
  ...
  padding-bottom: 16px;
`;
        const WeekDays = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  display: flex;
  justify-content: space-between;
  ...
  padding-bottom: 8px;
`;
        const WeekDay = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  flex: 1;
  text-align: center;
  font-weight: 500;
`;
        const DatesGrid = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  display: flex;
  flex-wrap: wrap;
`;
        const DateCell = styled_components__WEBPACK_IMPORTED_MODULE_2__[
          "default"
        ].div`
  width: 40px;
  height: 40px;
  ...
  &:hover {
    background-color: ${({ isSelected, isDisabled }) =>
      !isSelected && !isDisabled ? "#e6f0ff" : undefined};
  }
`;
        const CustomDatePicker = ({
          ...
          const [showCalendar, setShowCalendar] = (0,
          react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
          const [isManualNavigation, setIsManualNavigation] = (0,
          react__WEBPACK_IMPORTED_MODULE_1__.useState)(false); // Track manual navigation
            ...
            (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Header, {
              children: [
                  ...
                  Object.assign(
                    { onClick: handlePrevMonth },
                    {
                      ...
                      react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiChevronLeft,
                        {}
                      ),
                    }
                  )
                ...
                (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                  children: (0,
                  date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(
                    currentMonth,
                    "MMMM yyyy"
                  ),
                }),
                (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                  ...
                  Object.assign(
                    { onClick: handleNextMonth },
                    {
                      children: (0,
                      react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiChevronRight,
                        {}
                      ),
                    }
                  )
          ...
          const renderDays = () => {
            const days = [];
            const startDate = (0,
            date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(currentMonth, {
              weekStartsOn: 1,
            });
            for (let i = 0; i < 7; i++) {
              const day = (0, date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(
                startDate,
                i
              );
              days.push(
          ...
          const renderCells = () => {
            const monthStart = (0,
            date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentMonth);
            const monthEnd = (0,
            date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(currentMonth);
            const startDate = (0,
            date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(monthStart, {
              weekStartsOn: 1,
            });
            const endDate = (0,
            date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(monthEnd, {
              weekStartsOn: 1,
            });
            const rows = [];
            let days = [];
            ...
            while (day <= endDate) {
              for (let i = 0; i < 7; i++) {
                ...
                date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(day, "d");
                const cloneDay = day;
                ...
                day = (0, date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(
                  day,
                  1
                );
              }
  ...
  \*************************************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ BottomSheetFooter: () =>
            /* binding */ BottomSheetFooter,
          /* harmony export */
        });
        /* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        /* harmony import */ var react_icons_fi__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! react-icons/fi */ "./node_modules/react-icons/fi/index.esm.js"
          );
        /* harmony import */ var client_assets_images_savings_running_svg__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! client/assets/images/savings/running.svg */ "./src/client/assets/images/savings/running.svg"
          );
        /* harmony import */ var client_assets_images_savings_tree1_svg__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! client/assets/images/savings/tree1.svg */ "./src/client/assets/images/savings/tree1.svg"
          );
        /* harmony import */ var client_assets_images_savings_tree2_svg__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! client/assets/images/savings/tree2.svg */ "./src/client/assets/images/savings/tree2.svg"
          );
        /* harmony import */ var client_assets_images_savings_success_flag_svg__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(
            /*! client/assets/images/savings/success-flag.svg */ "./src/client/assets/images/savings/success-flag.svg"
          );
        /* harmony import */ var client_assets_images_savings_star_svg__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! client/assets/images/savings/star.svg */ "./src/client/assets/images/savings/star.svg"
          );
        ...
        const BottomSheetFooter = ({ title, onClick, loading }) => {
          ...
          return (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
            ...
            Object.assign(
              {
                className:
                  "bg-bottomSheetFooterBg bg-cover bg-no-repeat h-1/2 relative pb-5 pt-3",
              },
              {
                children: [
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                    ...
                    Object.assign(
                      {
                        className:
                          "absolute -top-5 right-0 left-0 flex flex-row justify-between items-center mx-3.5",
                      },
                      {
                        children: [
                          (0,
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            "img",
                            {
                              src: client_assets_images_savings_running_svg__WEBPACK_IMPORTED_MODULE_2__,
                            }
                          ),
                          (0,
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            "img",
                            {
                              src: client_assets_images_savings_tree1_svg__WEBPACK_IMPORTED_MODULE_3__,
                            }
                          ),
                          (0,
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            "img",
                            {
                              src: client_assets_images_savings_tree2_svg__WEBPACK_IMPORTED_MODULE_4__,
                            }
                          ),
                          (0,
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        ...
                        children: [
                          ...
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            ...
                            Object.assign(
                              {
                                className:
                                  "font-semibold text-1.5xl font-custom tracking-title text-skin-primary mb-5 mt-6 text-center mx-2",
                              },
                              {
                                children:
                                  fullTitle !== null && fullTitle !== void 0
                                    ? fullTitle
                                    : "",
                              }
                            )
                          ...
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            ...
                            Object.assign(
                              {
                                className:
                                  "rounded-full shadow-button bg-skin-primary h-14 w-14 flex items-center justify-center text-white mb-6",
                              ...
                              },
                              {
                                children: loading
                                  ...
                                  : (0,
                                    react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                      react_icons_fi__WEBPACK_IMPORTED_MODULE_5__.FiCheck,
                                      { size: "1.5rem" }
                                    ),
                              }
                            )
              ...
              { className: "relative" },
              {
                children: [
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    "img",
                    {
                      src: client_assets_images_savings_star_svg__WEBPACK_IMPORTED_MODULE_6__,
                  ...
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    "img",
                    {
                      src: client_assets_images_savings_success_flag_svg__WEBPACK_IMPORTED_MODULE_7__,
                    }
                  ),
                ],
              }
