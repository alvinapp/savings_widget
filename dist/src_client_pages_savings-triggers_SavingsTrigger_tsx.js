"use strict";
(self["webpackChunksavings_widget"] = self["webpackChunksavings_widget"] || []).push([["src_client_pages_savings-triggers_SavingsTrigger_tsx"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CustomDropDown": () => (/* binding */ CustomDropDown)
/* harmony export */ });
...
const CustomDropDown = ({ dataset, icon, height, onClick, exactData, }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        ...
        return () => {
            document === null || document === void 0 ? void 0 : document.removeEventListener("mousedown", handleClickOutside);
        };
    }, [ref]);
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", Object.assign({ className: "relative", ref: ref }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", Object.assign({ id: "day-dropdown", "aria-expanded": "true", "aria-haspopup": "true", className: "text-skin-base border border-1 border-skin-primary text-base font-poppins rounded-3xl px-4 py-2.5 text-center inline-flex items-center", type: "button", onClick: () => setIsOpen(!isOpen) }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "text-skin-neutral text-lg mr-2" }, { children: icon })), exactData, (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", Object.assign({ className: "text-skin-neutral" }, { children: [" ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", Object.assign({ className: "w-4 h-4 ml-2", "aria-hidden": "true", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" }) }))] }))] })), isOpen && dataset.length > 1 ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: `rounded-lg bg-skin-base p-3.5 w-full ${height !== null && height !== void 0 ? height : "h-20"} overflow-y-auto shadow-card` }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("ul", Object.assign({ className: "" }, { children: dataset.map((data, i) => {
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", Object.assign({ className: "text-tiny font-poppins font-medium tracking-progress_label block mb-4", onClick: () => {
                                if (onClick) {
                                    onClick(data);
                                }
                                setIsOpen(false);
...
/* harmony import */ var _assets_images_savings_goalviewoverlay_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../assets/images/savings/goalviewoverlay.svg */ "./src/client/assets/images/savings/goalviewoverlay.svg");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router/dist/index.js");
/* harmony import */ var _components_CustomDropDown__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/CustomDropDown */ "./src/client/pages/components/CustomDropDown.tsx");
...
/* harmony import */ var react_slide_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-slide-button */ "./node_modules/react-slide-button/build/index.js");
/* harmony import */ var react_slide_button__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_slide_button__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var client_store_savingsTriggerStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! client/store/savingsTriggerStore */ "./src/client/store/savingsTriggerStore.ts");
...
/* harmony import */ var client_assets_images_savings_trigger_success_svg__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! client/assets/images/savings/trigger-success.svg */ "./src/client/assets/images/savings/trigger-success.svg");
...
const SavingsTrigger = () => {
    ...
    const savingsTriggerStore = (0,client_store_savingsTriggerStore__WEBPACK_IMPORTED_MODULE_7__["default"])((state) => state);
    const { isFetching: savingTrigger, refetch: saveTheTrigger } = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)("save-trigger", () => (0,client_api_savings_triggers__WEBPACK_IMPORTED_MODULE_8__.saveTrigger)({
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", Object.assign({ className: "h-screen w-screen relative" }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "h-1/2 absolute top-0 left-0 right-0" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", Object.assign({ className: "relative" }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("img", { src: _assets_images_savings_goalviewoverlay_svg__WEBPACK_IMPORTED_MODULE_9__, className: "absolute object-cover w-screen" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "absolute top-28 left-0 right-0 flex flex-col items-center" })] })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "mt-6 absolute top-0 right-0 left-0 px-3.5" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_NavBar__WEBPACK_IMPORTED_MODULE_10__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-between items-center" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_BackButton__WEBPACK_IMPORTED_MODULE_11__["default"], { background: "bg-skin-base", onClick: () => navigate(-1) }) })) }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", Object.assign({ className: "w-screen rounded-t-3xl bg-skin-base absolute right-0 left-0 top-40 bottom-0 px-3.5 pt-12" }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-workSans font-semibold text-2xl text-skin-base" }, { children: "Round it up" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center mt-2 mx-12" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-poppins font-medium text-tiny text-skin-subtitle tracking-listtile_subtitle text-center" }, { children: "Automatically save on your daily spending" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center mt-6" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-workSans font-semibold text-base text-skin-base tracking-title" }, { children: "I would like to round up by" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row  mx-4 mt-5" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_slider__WEBPACK_IMPORTED_MODULE_12__["default"], { defaultValue: 1, className: "horizontal-slider", marks: [1, 2, 5, 10], markClassName: "example-mark", min: 0, max: 10, thumbClassName: "example-thumb", trackClassName: "example-track", renderThumb: (props, state) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({}, props, { children: `${state.valueNow}%` }))), onChange: (value) => {
                                savingsTriggerStore.setPercentage(value);
                            } }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center mt-6" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-workSans font-semibold text-base text-skin-base tracking-title" }, { children: "every time I transact at" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "mt-4 flex flex-row justify-center" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_CustomDropDown__WEBPACK_IMPORTED_MODULE_13__.CustomDropDown, { height: "h-56", dataset: savingsTriggerStore.merchants_dataset, icon: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_icons_fi__WEBPACK_IMPORTED_MODULE_14__.FiCreditCard, {}), onClick: (merchantName) => {
                                savingsTriggerStore.setMerchantName(merchantName);
                            }, exactData: savingsTriggerStore.merchant_name }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "border rounded-full bg-skin-divider mt-5.5 mb-4" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center mt-6" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-workSans font-semibold text-base text-skin-base tracking-title" }, { children: "and fund my" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "mt-4 flex flex-row justify-center" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_CustomDropDown__WEBPACK_IMPORTED_MODULE_13__.CustomDropDown, { dataset: [`${goal.confirmedGoal.name}`], icon: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_icons_fi__WEBPACK_IMPORTED_MODULE_14__.FiFlag, {}), height: "h-4", exactData: `${goal.confirmedGoal.name}` }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center mt-8" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "font-poppins font-medium text-xs text-skin-subtitle tracking-listtile_subtitle text-center" }, { children: "savings goal" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row mx-3.5 mt-1 mb-8 font-poppins tracking-widest text-skin-primary justify-center" }, { children: savingTrigger ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_loader_spinner__WEBPACK_IMPORTED_MODULE_3__.TailSpin, { height: "30", width: "30", color: "#056489", ariaLabel: "tail-spin-loading", wrapperStyle: {}, wrapperClass: "", visible: true })) : ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)((react_slide_button__WEBPACK_IMPORTED_MODULE_1___default()), { mainText: "Swipe to activate", caret: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_icons_fi__WEBPACK_IMPORTED_MODULE_14__.FiArrowRight, { color: "#ffffff", className: "absolute" }), onSlideDone: () => saveTheTrigger(), classList: "my-class", caretClassList: "my-caret-class", overlayClassList: "my-overlay-class", overlayWrapperClassList: "my-overlay-wrapper-class" })) }))] })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "flex flex-row justify-center items-center absolute left-0 right-0 top-28" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", Object.assign({ className: "h-23 w-23" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("img", { src: client_assets_images_savings_trigger_success_svg__WEBPACK_IMPORTED_MODULE_15__ }) })) }))] })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SavingsTrigger);
